...
- **잔여 미결정 5건**: 승인 라인(부서장 2단 여부)·상태이력 테이블 분리·`data` 유형 유니포인트 협의 게이트·SLA 수치·보존기간. 설계 [11 요청접수](11_챗봇_데이터요청접수_설계.md).
- **근거**: 마이그레이션 `portal_request_v1`, 정본 SQL `실제구축준비 자료/이관/sql/18_portal_request.sql`, `jeil-portal-request` v1.
