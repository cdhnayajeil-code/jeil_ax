-- 67_portal_page_proposal_ledger_rollback.sql
-- 되돌리기: 기안서 대장 2026 포털 등재 해제 (REQ-0077)
--
...
-- delete from public.portal_page where page_key = 'purchase_proposal_2026';   -- 권장하지 않음
